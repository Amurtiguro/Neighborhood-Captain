 ...
 * Generated at: 2021-06-05 08:20:51 UTC
...
public final class myInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//System.out.println("세션 회원번호 : "+sessionNum);
      ...
      out.write("\n");
      out.write("<link rel=\"stylesheet\" href=\"./include/css/myinfo.css\">\n");
      out.write("<script type=\"text/javascript\" src=\"http://dmaps.daum.net/map_js_init/postcode.v2.js\"></script>\n");
      out.write("<script src=\"./include/js/jquery-1.12.0.js\"></script>\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("\t$(document).ready(function(){\n");
      out.write("\t\tconsole.log(\"jQuery 실행 : \");\n");
      out.write("\t\t// POST 방식.\n");
      out.write("\t\t$('#myInfoForm').attr('method','POST');\n");
      out.write("\t\t\n");
      out.write("\t\t// 전 페이지인 마이페이지로 이동 버튼.\n");
      out.write("\t\t$('#myPage').click(function(){\n");
      out.write("\t\t\tconsole.log(\"마이페이지 실행 : \");\n");
      out.write("\t\t\t$('#myInfoForm').attr('action','/spw/myPage.spw');\n");
      out.write("\t\t\t$('#myInfoForm').submit();\n");
      out.write("\t\t});\n");
      out.write("\t\t// 수정 버튼.\n");
      out.write("\t\t$('#myUpdateOK').click(function(){\n");
      out.write("\t\t\tconsole.log(\"수정 실행 : \");\n");
      out.write("\t\t\t$('#myInfoForm').attr('action','/spw/memberUpdate.spw');\n");
      out.write("\t\t\t$('#myInfoForm').submit();\n");
      out.write("\t\t});\n");
      out.write("\t\t// 탈퇴 버튼.\n");
      out.write("\t\t$('#myDeleteOK').click(function(){\n");
      out.write("\t\t\tconsole.log(\"탈퇴 실행 : \");\n");
      out.write("\t\t\t$('#myInfoForm').attr('action','/spw/memberDelete.spw');\n");
      out.write("\t\t\t$('#myInfoForm').submit();\n");
      out.write("\t\t});\n");
      out.write("\t});\n");
      out.write("\t//주소검색\n");
      out.write("\tfunction addrCheck(){\n");
      out.write("\t\tconsole.log(\"---------- 다음 주소 검색 api ----------\");\n");
      ...
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t// 우편번호.\n");
      out.write("\t\t\t\t\tdocument.myInfoForm.maddr0.value = data.zonecode;\n");
      out.write("\t\t\t\t\t// 주소.\n");
      out.write("\t\t\t\t\tdocument.myInfoForm.maddr1.value = data.address;\n");
      out.write("\t\t\t\t\t// 상세주소.\n");
      out.write("\t\t\t\t\tdocument.myInfoForm.maddr2.value = data.buildingName;\n");
	...
	System.out.println("세션 회원번호 : "+sessionNum2);
      ...
      out.write("\t\t<div class=\"wrapper\">\r\n");
      out.write("\n");
      out.write("<div class=\"myinfo_contents\">\n");
      out.write("<form id=\"myInfoForm\" name=\"myInfoForm\">\n");
      out.write("<input type=\"hidden\" name=\"mnum\" id=\"mnum\" value=\"");
      out.print(mvo.getMnum() );
      out.write("\"/>\n");
      out.write("<h2>회원정보 수정</h2>\n");
      out.write("<div class=\"myinfo_func\">\n");
      out.write("\t<span>\n");
      out.write("\t\t<input type=\"button\" value=\"뒤로\" name=\"myPage\" id=\"myPage\" class=\"sitebtn\"/>\n");
      out.write("\t\t<input type=\"submit\" value=\"수정\" name=\"myUpdateOK\" id=\"myUpdateOK\" class=\"sitebtn\"/>\n");
      out.write("\t\t<input type=\"button\" value=\"탈퇴\" name=\"myDeleteOK\" id=\"myDeleteOK\" class=\"sitebtn\"/>\t\t\n");
      out.write("\t</span>\n");
      out.write("</div>\n");
      out.write("<div class=\"myinfo_form\">\n");
      out.write("\t<div class=\"myinfo_center\">\n");
      out.write("\t\t<div class=\"myinfo_left\">\n");
      out.write("\t\t\t<!-- <a>번호</a><br> -->\n");
      out.write("\t\t\t<a>아이디</a><br>\n");
      out.write("\t\t\t<a><font>*</font>비밀번호</a><br>\n");
      out.write("\t\t\t<a><font>*</font>이름</a><br>\n");
      out.write("\t\t\t<a><font>*</font>휴대폰 번호</a><br>\n");
      out.write("\t\t\t<a><font>*</font>이메일</a><br>\n");
      out.write("\t\t\t<a><font>*</font>우편번호</a><br>\n");
      out.write("\t\t\t<a><font>*</font>주소</a><br>\t\n");
      out.write("\t\t\t<a><font>*</font>상세주소</a><br>\t\t\n");
      out.write("\t\t\t<a>회원등록일</a>\n");
      out.write("<!-- \t\t\t<a>등록일</a><br>\n");
      out.write("\t\t\t<a>수정일</a> -->\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"myinfo_middle\">\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"mid\" id=\"mid\" value=\"");
      out.print(mvo.getMid() );
      out.write("\" disabled/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"mpw\" id=\"mpw\" value=\"");
      out.print(mvo.getMpw() );
      out.write("\"/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"mname\" id=\"mname\" value=\"");
	...
	if(ynBar>0){
      ...
      out.write("\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"mphone\" id=\"mphone\" value=\"");
      ...
      out.write("\t\t\t\t\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"memail\" id=\"memail\" value=\"");
      out.print(mvo.getMemail() );
      out.write("\"/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"maddr0\" id=\"maddr0\" value=\"");
      out.print(mvo.getMaddr0() );
      out.write("\"/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"maddr1\" id=\"maddr1\" value=\"");
      out.print(mvo.getMaddr1() );
      out.write("\"/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"maddr2\" id=\"maddr2\" value=\"");
      out.print(mvo.getMaddr2() );
      out.write("\"/></span><br>\n");
      out.write("\t\t\t<span><input type=\"text\" name=\"mregdate\" id=\"mregdate\" value=\"");
      out.print(mvo.getMregdate() );
      out.write("\" readOnly/></span>\n");
      out.write("\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"myinfo_right\">\n");
      out.write("\t\t\t<input type=\"button\" onclick=\"addrCheck()\" value=\"주소\" class=\"sitebtn\">\n");
      out.write("\t\t\t\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
