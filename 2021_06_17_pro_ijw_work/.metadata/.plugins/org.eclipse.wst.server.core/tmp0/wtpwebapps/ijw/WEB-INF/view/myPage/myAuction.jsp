...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#myUpdate').click(function(){
			//console.log("수정버튼 실행 : ");
			$('#myPageForm').attr('action','/ijw/myInfo.spw');
			$('#myPageForm').submit();
		});
		...
		$('#delAuction').click(function(){
			...
			if(cbCnt==0){
				...
				if(pick==true){
					console.log("삭제");
					document.myPageForm.action="/ijw/myAuctionDel.ijw?anum="+anum+"&asort="+asort;
	...
	function searchDate(){
		...
		location.href="/ijw/myAuction.ijw?"+qStr;
	}	
	// 체크 박스 1개 선택.
...
%>
			<li class="grid_item">
				<a href="/ijw/auctionViewDetail.ijw?anum=<%=mavo.getAnum()%>">
					<div class="grid_item_box">
						<div class="grid_img">
							...
							<img src="/ijw/editImages/Thumb_<%=mavo.getAphoto() %>">
						</div>
...
%>
	...
	<div class="list_paging paging_saja">
		...
		<jsp:param name="url" value="/ijw/myAuction.ijw"/>
