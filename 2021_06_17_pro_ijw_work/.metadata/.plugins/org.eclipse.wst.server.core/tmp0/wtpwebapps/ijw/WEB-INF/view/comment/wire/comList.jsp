...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function reloadComment(){
			...
			// URL
			var dataUrl = "/ijw/comment/listData.ijw";
		...
		function insertComment(formEle, fnAct){
			...
			var insertURL = "/ijw/comment/insert.ijw";
		...
		function updateComment(formEle, fnAct){
			...
			// URL
			var updateURL = "/ijw/comment/update.ijw";
		...
		function deleteComment(btnEle){
			...
			if(confirm("삭제하시겠습니까?")){
				var insertURL = "/ijw/comment/delete.ijw";
		...
		function showUpdate(){
			...
			// 수정 데이터 가져오기 (ajax)
			// URL
			var selCommURL = "/ijw/comment/update.ijw";
