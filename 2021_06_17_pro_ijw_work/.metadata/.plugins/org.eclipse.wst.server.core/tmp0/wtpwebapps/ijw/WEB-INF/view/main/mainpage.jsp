...
<%
	request.setAttribute("siteTitle", "구매판매");
%>
<%@include file="/WEB-INF/view/main/top1.jsp" %>
<script type="text/javascript" src="/ijw/include/js/mainbaner.js"></script>
...
<div class="slideshow-container">
	...
	<div class="mySlides fade2">
		<img class="main_slideImg" src="/ijw/include/img/baner1.jpg">
		
	</div>
	<div class="mySlides fade2">
		<img class="main_slideImg" src="/ijw/include/img/baner2.png">
		
	</div>
	<div class="mySlides fade2">
		<img class="main_slideImg" src="/ijw/include/img/baner5.png">
...
<div class="bar_list">
	<h3 class="bar_title">최근 판매</h3>
	<div class="list_contents">
		<c:if test="${empty pandaList}">
		<div class="list_msg">
			<h3>최근 게시된 판매된 글이 없습니다.</h3>
		</div>
		</c:if>
		...
		<div class="list_grid">
			<ul>
				...
				<li class="grid_item">
					<a href="/ijw/generalDetailForm.ijw?gnum=${gvoPanda.gnum}">
						<div class="grid_item_box">
							<div class="grid_img">
								<div class="grid_img_label label_panda">
									판매
								</div>
								<img src="/ijw/editImages/Thumb_${gvoPanda.gphoto}">
							</div>
...
<div class="bar_list">
	<h3 class="bar_title">최근 구매</h3>
	<div class="list_contents">
		<c:if test="${empty sajaList}">
		<div class="list_msg">
			<h3>최근 게시된 구매된 글이 없습니다.</h3>
		</div>
		</c:if>
		...
		<div class="list_grid">
			<ul>
				...
				<li class="grid_item">
					<a href="/ijw/generalDetailForm.ijw?gnum=${gvoSaja.gnum}">
						<div class="grid_item_box">
							<div class="grid_img">
								<div class="grid_img_label label_saja">
									구매
								</div>
								<img src="/ijw/editImages/Thumb_${gvoSaja.gphoto}">
							</div>
							<div class="grid_label">
								<h3 class="grid_title">
									${gvoSaja.gtitle}
	...
	<div class="list_contents">
		...
		<div class="list_grid">
			<ul>
				...
				<li class="grid_item">
					<a href="/ijw/auctionViewDetail.spw?anum=${gvoAuction.anum}">
						<div class="grid_item_box">
							<div class="grid_img">
								<div class="grid_img_label label_auction">
									경매
								</div>
								<img src="/ijw/editImages/Thumb_${gvoAuction.aphoto}">
							</div>
							<div class="grid_label">
								<h3 class="grid_title">
									${gvoAuction.atitle}
