<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.ijw.auction.vo.AuctionVO" %>
...
<script type="text/javascript">
	...
	function useServerTime(fnUse){
		...
		// 서버시간을 가져올 URL
		var timeURL = "/ijw/getServerTime.ijw";
	...
	$(document).ready(function() {
		...
		$("#update").click(function(){
			$("#detailForm").attr({
				...
				"action":"/ijw/auctionUpdateView.ijw"
			}).submit();
		});
		...
		<div class="wrapper">
			<div class="product_detail">
				<div class="product_top">
					...
					<div class="product_info_images" style="background-image: url('/ijw/uploadImages/<%=auvo.getAphoto()%>');" alt="상품 이미지">
						<img src="/ijw/uploadImages/<%=auvo.getAphoto() %>"/>
					</div>
				...
				<div class="product_content">
					...
					<div class="product_content_btn">
						<a href="/ijw/auctionUpdateView.ijw?anum=<%=auvo.getAnum()%>" class="sitebtn" id="update">수정</a>
						<a href="/ijw/auctionDelete.ijw?anum=<%=auvo.getAnum()%>" class="sitebtn" id="delete">삭제</a>
						<a href="/ijw/auctionList.ijw" class="sitebtn">목록</a>
					</div>
				</div>
			</div>
		</div>
