...
<div class="list_sort">
	<div class="tab_sort tab_panda">
		<a href="/ijw/adminSelectAll.ijw">회원관리</a>
	</div>
	...
	<thead>
		<tr>
			<td class="col_right" colspan="7">
				<form method="GET" action="/ijw/comment/listall.ijw" id="commSearch">
...
<c:forEach items="${commentList}" var="cvo">
			<tr>
				...
				<td>
					<a href="/ijw/comment/delete.ijw?cnum=${cvo.cnum}" class="delCmt sitebtn">삭제</a>
				</td>
			</tr>
...
<div class="list_paging">
	<p style="text-align: right;">
		<jsp:include page="paging.jsp">
			<jsp:param name="url" value="comment/listall.ijw"/>
