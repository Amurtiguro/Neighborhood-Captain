<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.ijw.deal.vo.DealVO" %>
<%
...
<script type="text/javascript">
	...
	/* 	document.dealForm.method="GET";
		document.dealForm.action="/ijw/dealInsert.ijw";
...
<form id="dealForm" name="dealForm">
	...
	알림에 들어갈 url : <input type="text" name="nurl" id="nurl" value="ijw/generalDetailForm.ijw?gnum=<%=dvo.getGnum()%>"><br>
