...
<%
	request.setAttribute("siteTitle", "구매 목록");
%>
...
<script type="text/javascript">
	...
	function generalDetailForm(){
		...
		$("#sList #gnum").val(gnum);
		$("#sList").attr("action", "generalDetailForm.ijw");
		$("#sList").submit();
	}
...
%>
		...
		<div class="list_paging paging_saja">
			...
			<jsp:param name="url" value="/ijw/generalSList.ijw"/>
