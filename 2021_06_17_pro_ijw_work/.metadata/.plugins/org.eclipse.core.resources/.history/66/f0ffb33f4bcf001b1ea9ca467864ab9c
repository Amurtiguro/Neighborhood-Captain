package com.ijw.auction.controller;
...
import com.ijw.auction.service.AuctionService;
...
//	static String path = "\\ijw\\uploadImages";
	...
	public ModelAndView insertAuction(@ModelAttribute AuctionVO auvo, HttpServletRequest req) {
		...
		if(res>0) {
			...
			mav.setViewName("redirect:auctionList.ijw");
		}
		return mav;
	}
