<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	request.setAttribute("siteTitle", "구매판매 상품등록");
%>
...
<script type="text/javascript">
	...
	function generalInsert(){
		...
		insertForm.action="generalInsert.ijw";
		insertForm.submit();
	}
	...
	function generalAllList(){
		...
		var sort = $('#gsort').val();
		if(sort=="1"){
			location.href="/ijw/generalSList.ijw";
		}else{
			location.href="/ijw/generalPList.ijw";
		}
	}
	...
	<div class="formcontent">
		<form id="insertForm" name="insertForm">
			...
			<div class="formrow">
				...
				<select id="cgnum" name="cgnum" class="sitetxt form_ele_50" id="form_ele_50">
					<!-- <option>대분류</option> -->
