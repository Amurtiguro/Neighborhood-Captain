...
<%@ page import="com.ijw.general.dao.GeneralDaoImpl" %>
...
<script type="text/javascript">
	...
	function generalInsertForm(){
		...
		location.href="generalInsertForm.ijw";
	}
	...
	function generalDetailForm(){
		...
		$("#aList #gnum").val(gnum);
		$("#aList").attr("action", "generalDetailForm.ijw");
		$("#aList").submit();
	} 
	
	/* 구매목록 : generalSList */
	function generalSList(){
		console.log("구매목록 : generalSList");
		location.href="generalSList.ijw";
	}
	
	
	/* 판매목록 : generalPList */
	function generalPList(){
		console.log("판매목록 : generalPList")
		location.href="generalPList.ijw";
	}
...
%>
	...
	<div>
		<tr>
			<td align="left">
			<input type="button" value="구매 목록" onclick="generalSList()" />
			<input type="button" value="판매 목록" onclick="generalPList()" /></td>
		</tr>
	</div>
	<div>
		<table border="1">
...
%>
			...
			<tr align="center">
				...
				<td><img src="/ijw/uploadImages/<%=gvo.getGphoto() %>" border=0 width="100" ></td><!-- 사진 -->
				<td><img src="/ijw/editImages/Thumb_<%=gvo.getGphoto() %>" border=0 width="50" ></td><!-- 썸네일 -->   
			...
			<tr>
				<td colspan = "15" align="right">
					<jsp:include page="paging.jsp" flush="true">
						<jsp:param name="url" value="/ijw/generalAllList.ijw"/>
