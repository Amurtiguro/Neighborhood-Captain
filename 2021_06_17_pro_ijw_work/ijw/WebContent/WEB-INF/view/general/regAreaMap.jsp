...
<%@include file="/WEB-INF/view/main/top2.jsp" %>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=94a84c1fd98daa86404073f93500e559"></script>
	<script type="text/javascript" src="/ijw/include/js/reglist.js"></script>
	<script type="text/javascript" src="/ijw/include/js/regAreaMap.js"></script>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var areaMap = regAreaMap(map, function(regcode){
				...
				location.href="/ijw/local.spw?gregcode=" + regcode;
			});
