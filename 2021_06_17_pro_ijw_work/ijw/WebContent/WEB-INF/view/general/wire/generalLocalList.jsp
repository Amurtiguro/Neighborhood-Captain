...
<meta charset="UTF-8">
<title>동네별 목록</title>
<script type="text/javascript" src="/ijw/js/jquery-1.12.0.js"></script>
</head>
<body>
<jsp:include page="/category/list.ijw">
	<jsp:param name="qString" value="gregcode=${gvo.gregcode}&gsort=${gvo.gsort}"/>
</jsp:include>
<form method="GET" action="/ijw/general/local.ijw" id="formQstr">
...
<div>
	<a href="/ijw/general/local.ijw?gregcode=${gvo.gregcode}&gsort=1">구매</a>
	<a href="/ijw/general/local.ijw?gregcode=${gvo.gregcode}&gsort=2">판매</a>
</div>
<div id="regInfo">
	선택한 지역 :
...
<script type="text/javascript" src="/ijw/js/reglist.js"></script>
<script>
...
<%
	...
	if(gvo != null){
		...
		String edate = gvo.getGupdate();
		if(edate != null && edate.length(
...
%>
<a href="/ijw/regAreaMap.ijw">지도 보기</a>
<table border>
	<thead>
		<tr>
			<th>일반 상품번호</th>
