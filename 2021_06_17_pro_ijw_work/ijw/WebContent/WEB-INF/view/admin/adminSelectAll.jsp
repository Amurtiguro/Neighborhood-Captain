...
<script type="text/javascript">
	...
	function adminDel(){
		document.adminSelectForm.action="/ijw/adminDel.ijw";
		document.adminSelectForm.submit();
	}
	function searchData(){
		//검색할 아이디를 받아서 vo에 담아서 셀렉트로 가야한다.
		document.adminSelectForm.method="get"
		document.adminSelectForm.action="/ijw/adminSelectAll.ijw";
		document.adminSelectForm.submit();
	}     
</script>
...
%>
	...
	<div class="list_sort">
    	...
    	<div class="tab_sort tab_comment">
    		<a href="/ijw/comment/listall.ijw">댓글 관리</a>
    	</div>
    </div>
	<br>
	<br> 
	...
	<jsp:include page="paging.jsp" flush="true">
			<jsp:param name="url" value="/ijw/adminSelectAll.ijw"/>
