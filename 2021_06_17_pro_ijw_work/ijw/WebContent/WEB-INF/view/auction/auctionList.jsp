...
<script type="text/javascript" src="/ijw/include/js/autciontList.js"></script>
<script type="text/javascript">
	
	function auctionInsert(){
		console.log("insert btn click >>> ");
		document.detailForm.method="GET";
		document.detailForm.action="/ijw/auctionWrite.ijw";
	...
	function detailAuction(){
		...
		document.detailForm.method="GET";
		document.detailForm.action="/ijw/auctionViewDetail.ijw";
		document.detailForm.submit();
	}
...
%>
				<li class="grid_item">
					<a href="/ijw/auctionViewDetail.ijw?anum=<%=alist.get(i).getAnum() %>">
						<div class="grid_item_box">
							<div class="grid_img">
								<div class="grid_img_label label_auction">
									경매
								</div>
								<img src="/ijw/editImages/<%=alist.get(i).getArephoto()%>" width="192"/>
							</div>
