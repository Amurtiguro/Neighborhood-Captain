...
<%@ page import="com.ijw.mypage.vo.MyPickVO" %>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#delPick').click(function(){
			...
			if(cbCnt==0){
				...
				if(pick==true){
					console.log("삭제");
					location.href="/ijw/myPickDel.ijw?pnum="+pnum+"&gsort="+gsort;
				}
			}
		});
		 // DatePicker Format.
	...
	function searchDate(){
		...
		location.href="/ijw/myPick.ijw?"+qStr;
	}	
	// 체크 박스 1개 선택.
...
%>
			<li class="grid_item">
				<a href="/ijw/generalDetailForm.ijw?gnum=<%=mpvo.getGnum()%>">
					<div class="grid_item_box">
						<div class="grid_img">
							...
							<img src="/ijw/editImages/Thumb_<%=mpvo.getGphoto() %>">
						</div>
...
%>
	...
	<div class="list_paging paging_saja">
		...
		<jsp:param name="url" value="/ijw/myPick.ijw"/>
