...
<c:forEach items="${commentList}" var="cvo">
	...
	<c:if test="${cvo.cdelyn == 'N'}">
		<tr>
			...
			<td>${cvo.tarname}</td>
			<td>
				<a href="/ijw/comment/insert.ijw?cpnum=${param.cpnum}&cgroupnum=${cvo.cgroupnum}&ctargetnum=${cvo.cnum}">답글</a>
			</td>
			<td>
				<a href="/ijw/comment/update.ijw?cnum=${cvo.cnum}">수정</a>
			</td>
			<td>
				<a href="/ijw/comment/delete.ijw?cnum=${cvo.cnum}">삭제</a>
			</td>
		</tr>
	</c:if>
</c:forEach>
...
<jsp:include page="/comment/insert.ijw">
